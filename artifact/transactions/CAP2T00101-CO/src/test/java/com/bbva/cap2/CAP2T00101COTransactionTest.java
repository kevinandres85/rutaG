...
/**
 * Test for transaction CAP2T00101COTransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/CAP2T00101COTest.xml" })
public class CAP2T00101COTransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(CAP2T00101COTransactionTest.class);
	
	@Autowired
	private CAP2T00101COTransaction transaction;
